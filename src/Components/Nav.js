...
function Nav() {
  ...
  return (
    <>
      <div className="absolute w-full h-24 md:flex  justify-between md:items-center lg:mt-10 ">
        ...
        {burgerClick ? (
          <div className="absolute md:hidden top-0 right-0  w-64 bg-neutral-whiteblur backdrop-blur-lg h-[647px]">
